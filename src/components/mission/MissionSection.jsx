  ...
  return (
    ...
    >
      <div className="container">
        {/* Section Header: 3D Surface Reveal */}
        ...
        {/* 2 Core Subteams Presentation: Staggered 3D Surface Rise */}
        <div
          style={{
            display: 'grid',
        ...
        >
          {subteamsData.map((subteam, idx) => (
            <SurfaceReveal key={subteam.id} delay={idx * 0.18} yOffset={70} rotateAngle={18}>
              <div
        ...
        {/* Engineering Philosophy Banner with 3D Rise */}
        <SurfaceReveal delay={0.25} yOffset={50} rotateAngle={14}>
          <div
