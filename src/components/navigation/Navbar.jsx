...
import { Rocket, Menu, X, Radio, Target, Terminal, Users, BookOpen, HeartHandshake } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

/**
 * Modern Frosted White Glass Navbar
 * - Robust mobile-first rendering: Zero ghost bars or overlapping pill artifacts on mobile
 * - Desktop: Translucent white glass capsule morphing into floating frosted glass pills on scroll
 * - Mobile: Ultra-clean Left Brand Pill + Right Frosted Glass Hamburger Trigger
 */
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* 1. Desktop Top White Glass Capsule Bar (Desktop Only) */}
          {!isMobile && (
            <motion.div
              initial={false}
              animate={{
          ...
          <div
            style={{
              ...
              left: isMobile ? '0' : 'clamp(1rem, 4vw, 3.5rem)',
              display: 'flex',
              alignItems: 'center',
              pointerEvents: 'auto',
              zIndex: 2,
          ...
          >
            <Link
              ...
              style={{
                ...
                borderRadius: 'var(--radius-pill)',
                background: isMobile || isScrolled ? 'rgba(255, 255, 255, 0.14)' : 'transparent',
                backdropFilter: isMobile || isScrolled ? 'blur(20px)' : 'none',
                WebkitBackdropFilter: isMobile || isScrolled ? 'blur(20px)' : 'none',
                border: isMobile || isScrolled ? '1px solid rgba(255, 255, 255, 0.28)' : '1px solid transparent',
                boxShadow: isMobile || isScrolled ? '0 4px 20px rgba(0, 0, 0, 0.3)' : 'none',
          ...
          {/* 3. Center Navigation Track (Rendered ONLY on Desktop >= 900px) */}
          {!isMobile && (
            <motion.div
              layout
          ...
          {/* 4. Right Action (Desktop Engage CTA / Mobile Hamburger) */}
          <div
            style={{
              position: isMobile ? 'relative' : 'absolute',
              right: isMobile ? '0' : 'clamp(1rem, 4vw, 3.5rem)',
              display: 'flex',
              alignItems: 'center',
              zIndex: 2,
              pointerEvents: 'auto',
          ...
          >
            ...
            {/* Mobile Toggle Button (Rendered ONLY on Mobile) */}
            {isMobile && (
              <motion.button
                whileTap={{ scale: 0.9 }}
                type="button"
        ...
        {isMobile && isMobileMenuOpen && (
          <motion.div
            ...
            style={{
              ...
              padding: '1.25rem',
              zIndex: 999,
              boxShadow: '0 25px 60px rgba(0, 0, 0, 0.85), inset 0 1px 1px rgba(255, 255, 255, 0.3)',
            }}
          >
